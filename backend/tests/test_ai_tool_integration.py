...
class TestAIGeneratorToolCalling:
    ...
    def test_ai_generator_calls_search_tool_with_correct_params(self, mock_anthropic_client, mock_vector_store):
        ...
        text_response.content = [MagicMock(type="text", text="Here's info about MCP servers")]
        mock_anthropic_client.messages.create.side_effect = [mock_response, text_response]
    ...
    def test_ai_generator_accumulates_sources_across_rounds(self, mock_anthropic_client, mock_vector_store):
    ...
    def test_ai_generator_handles_tool_error_response(self, mock_anthropic_client, mock_vector_store):
        ...
        final_response = MagicMock()
        final_response.stop_reason = "end_turn"
        final_response.content = [MagicMock(type="text", text="I couldn't find that information")]
    ...
    def test_ai_generator_respects_max_rounds_limit(self, mock_anthropic_client, mock_vector_store):
        ...
        final_response = MagicMock()
        final_response.stop_reason = "end_turn"
        final_response.content = [MagicMock(type="text", text="Final synthesized response")]
    ...
    def test_ai_generator_without_tools(self, mock_anthropic_client):
        ...
        text_response = MagicMock()
        text_response.stop_reason = "end_turn"
        text_response.content = [MagicMock(type="text", text="Direct answer without searching")]
...
class TestConversationState:
    ...
    def test_add_tool_results(self):
        ...
        tool_results = [{"type": "tool_result", "tool_use_id": "123", "content": "result"}]
