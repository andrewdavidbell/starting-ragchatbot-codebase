...
class ConversationState:
    ...
    def can_use_tools(self) -> bool:
        ...
        return self.tools is not None and self.tool_manager is not None and self.current_round < self.max_rounds
...
"""
    ...
    def generate_response(self, query: str,
                         ...
                         tool_manager=None) -> Tuple[str, List]:
        """
    ...
    def _execute_multi_round_conversation(self, state: ConversationState) -> str:
        ...
        while state.current_round < state.max_rounds:
            ...
            if response.stop_reason == "tool_use" and state.can_use_tools():
                ...
                tool_execution_success = self._execute_tools_and_update_state(response, state)
